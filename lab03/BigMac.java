// Assignment: Write a program that computes the cost of buying a some Big Macs.
// It uses the Scanner class to obtain from the user how many Big Macs, the cost per Big Mac,
...
public class BigMac {
    public static void main(String[] args) {
        ...
        "a couble (in the form xx.xx): ");
        double bigMac$ = myScanner.nextDouble();
        System.out.print(
            "Enter the tax as a whole number (xx): ");
        ...
        //get the whole amount, dropping deimal fraction
        dollars=(int)cost$;
